...
public class RectBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(0, viewHeight / 2, viewWidth, viewHeight / 2, paint); // drawLine(x,y,筆)畫線的方法
        ...
        for (int i = 0; i < 20; i++) {
            canvas.drawCircle((space + (i * space)), viewHeight / 2, 5f, paint); // drawCircle(x,y,半徑,筆)畫圈方法
        }
